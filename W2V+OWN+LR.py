...
out_csv_name = f'W2VLR_test/{project}_W2VLR.csv'
...
print("=== Logistic Regression + Word2Vector Results ===")
...
print("Saving to:", os.path.abspath(out_csv_name))
